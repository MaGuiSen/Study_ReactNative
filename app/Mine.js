            ...
            <ScrollView style={styles.container}>
                ...
                <View style={[styles.serveLay,,{paddingTop:20}]}>
                    <View style={styles.serveItem}>
                        <Image style={styles.serveImg} source={{uri: 'http://file.1ping.com/Public/app/images/screen/yao_banner.jpg'}}></Image>
                ...
                <View style={styles.docLay}>
                    ...
                    <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                        <View style={styles.serveItem}>
                            <Image style={styles.docImg} source={{uri: 'http://file.1ping.com/Public/app/images/screen/yao_banner.jpg'}}></Image>
